...
def main():
    ...
    query_text = st.text_input("กรุณาลงข้อมูลสุขภาพ/ข้อกังวล")
    ...
    if query_text:
        ...
        # Prepare the DB.
        openai_api_key = "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"  # Replace with your actual OpenAI API key
